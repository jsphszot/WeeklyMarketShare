/*
Gateway MarketShare: 
Takes Market info for Cargo tons, calculates weekly MarketShare for LA and 
top competitors per Origin-Destination group.
*/
...
WITH cookie2 AS (
    SELECT 
    CASE 
        WHEN Origen = 'USA' AND Destino = 'CHILE' THEN CONCAT(Origen, ' - ', Destino, " ", TipoVuelo)
